...
#define VARLEN_COLUMN static_cast<uint32_t>(INT32_MIN & 16)  // 16 with the first (most significant) bit set to 1
/**
...
class BlockLayout {
 public:
   ...
   */
  explicit BlockLayout(std::vector<uint32_t> attr_sizes);
